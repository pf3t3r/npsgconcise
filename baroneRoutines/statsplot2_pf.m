function [MLEp,KSp,nll] = statsplot2(x,nc,i)
%
%
...
%       graphically.      
%   i: what level the histogram applies to
% OUTPUT
...
%
% Author: B.Barone
% Edited by P. Farrell to show histogram output only.
...
%     sp1 = subplot(2,3,1);
    ...
    hold off
    title('\bf Histogram & MLE pdf ('+string(2*i) + ' db)');
